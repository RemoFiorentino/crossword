...
function Crossword(words_in, clues_in){
    ...
    this.toposx = function(){
        return words;
    }
    this.toposy = function(){
        return wordsx;
    }
    this.topos2x = function(){
        return wordsy;
    }
    this.topos2y = function(){
        return words_in;
    }
    this.topos2 = function(grid){
        if(grid == null) return;
        var label = 1;
    ...
    var addCellToGrid = function(word, index_of_word_in_input_list, index_of_char, r, c, direction){
        ...
        if(grid[r][c] == null){
            ...
            if(index_of_char == 0){
              if(direction == "across"){
                words[words_in.indexOf(word)] = "across";
                wordsx[words_in.indexOf(word)] =r;
                wordsy[words_in.indexOf(word)] =c;
              }else{
                words[words_in.indexOf(word)] = "down";
                wordsx[words_in.indexOf(word)] =r;
                wordsy[words_in.indexOf(word)] =c;
              }
            }
